...
import { getSummary } from "./services/dataHandle.service";
import { getCurrentDateTime } from "./utils/dateTime.util";
import { setLoadSummary, setUpdated } from "./actions/dataActions";
...
const mapDispatchToProps = (dispatch) => ({
  setPairs: (pairs) => dispatch(setLoadSummary(pairs)),
